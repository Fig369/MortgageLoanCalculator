...
WORKDIR /src
COPY ["MortgageLoanCalculator/MortgageLoanCalculator/MortgageLoanCalculator.csproj", "MortgageLoanCalculator/"]
...
# Use .NET 6.0 as the base image for the final stage
